...
public class ArticulosAdapters extends ArrayAdapter<Articulos>
{

    //public static byte[] img;
    private List<Articulos> opciones = new ArrayList<>();

    public ArticulosAdapters(Context context, List<Articulos> datos){
        super(context, R.layout.lst_articulos, datos);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View item = inflater.inflate(R.layout.lst_articulos, null);
